...
namespace KBEngine
{
	...
	public struct SERVER_ID
	{
		UInt16 value;

		SERVER_ID(UInt16 value)
		{
			this.value = value;
		}

		public static implicit operator UInt16(SERVER_ID value)
		{
			return value.value;
		}

		public static implicit operator SERVER_ID(UInt16 value)
		{
			UInt16 tvalue = (UInt16)value;
			return new SERVER_ID(tvalue);
		}
